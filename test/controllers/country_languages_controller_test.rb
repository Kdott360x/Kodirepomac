...
class CountryLanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country_language" do
    assert_difference('CountryLanguage.count') do
      post country_languages_url, params: { country_language: { country_id: @country_language.country_id, language_id: @country_language.language_id } }
    end
  ...
  test "should update country_language" do
    patch country_language_url(@country_language), params: { country_language: { country_id: @country_language.country_id, language_id: @country_language.language_id } }

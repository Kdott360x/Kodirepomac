  ...
  def create
    ...
    respond_to do |format|
      if @country_language.save
        format.html { redirect_to country_language_url(@country_language), notice: "Country language was successfully created." }
  ...
  def update
    respond_to do |format|
      if @country_language.update(country_language_params)
        format.html { redirect_to country_language_url(@country_language), notice: "Country language was successfully updated." }
